...
func MarshalWithOptions(v interface{}, optionsString string) ([]byte, error) {
...
func NewEncoder(v interface{}, opts *options) Encoder {
...
func (i identifier) encode() []byte {
	...
	if i.tag <= 30 {
		...
		b = append(b, encodeBase128(uint(i.tag))...)
	}
